...
export default class Anxiety extends Component {
  render() {    
    ...
    return (
      ...
      SectionParagraph="Anxiety allows us to be alert and take action when needed. 
      But when it becomes overwhelming and paralyzes us, treatment can help.
      Generalized Anxiety disorder is a condition of excess worry, feeling on edge, 
      fatigue, poor concentration, irritability, muscle tension, and insomnia. 
      Panic attacks are waves of intense anxiety with physical symptoms such as palpitations, sweating, 
      ...
      Studies show the efficacy of antidepressant medication and a specific type of CBT referred to as
